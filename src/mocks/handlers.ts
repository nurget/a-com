...
export const handlers = [
    ...
    http.get('/api/trends', ({ request }) => {
        return HttpResponse.json(
            [
                {tagId: 1, title: '우주소녀', count: 1264},
                {tagId: 2, title: '엑시', count: 1264},
                {tagId: 3, title: '설날 용돈', count: 1264},
                {tagId: 4, title: '예일대 학생증', count: 1264},
                {tagId: 5, title: '신혼부부', count: 1264},
                {tagId: 6, title: '버블 프사', count: 1264},
                {tagId: 7, title: '할머니집', count: 1264},
                {tagId: 8, title: '크라임씬', count: 1264},
                {tagId: 9, title: '트친누나들', count: 1264},
            ]
        )
    }),
];