...
export default function NavMenu() {
    ...
    console.log(segment); // home에 가면 home이 되고, explore가 되면 explore
    // 현재 레이아웃에서 compose/tweet의 폴더구조면 compose만 나옴
    // tweet까지 같이 나오게 하고싶으면 useSelectedLayoutSegments()를 사용해야 함! -> ['compose', 'tweet']
    const me = {
        // 임시로 내 정보 있는 것처럼
        id: 'nurget'
    }
